...
internal static class PlayerPowerUpContainerBakeUtility
{
    ...
    /// /params progressionPreset: Progression preset that owns the dropped-container settings.
    ...
    /// /params containerPrefab: Prefab asset used to spawn dropped containers.
