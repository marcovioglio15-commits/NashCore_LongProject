...
internal sealed class HUDPowerUpOverlaySection
{
    ...
    /// /params primaryIconImage: Primary slot icon image.
    /// /params secondaryIconImage: Secondary slot icon image.
    /// /params primaryEnergyFillImage: Primary slot energy fill image.
    /// /params secondaryEnergyFillImage: Secondary slot energy fill image.
    /// /params primaryChargeFillImage: Primary slot charge fill image.
    /// /params secondaryChargeFillImage: Secondary slot charge fill image.
    /// /params energyBarSmoothingSecondsValue: Smoothing time applied to energy bars.
    /// /params hideEnergyBarsWhenPlayerMissingValue: Hides energy bars when the player entity is unavailable.
    /// /params hideEnergyBarsWhenModuleMissingValue: Hides energy bars when the slot has no energy module.
    /// /params chargeBarSmoothingSecondsValue: Smoothing time applied to charge bars.
    /// /params hideChargeBarsWhenPlayerMissingValue: Hides charge bars when the player entity is unavailable.
    /// /params hideChargeBarsWhenModuleMissingValue: Hides charge bars when the slot has no charge module.
    ...
    /// /params entityManager: Entity manager used to read runtime power-up components.
    /// /params playerEntity: Player entity currently driving the overlay.
    /// /returns void.
    /// </summary>
    ...
    /// /params slotConfig: Slot configuration currently bound to the HUD slot.
    ...
    /// /params slotConfig: Slot configuration currently bound to the HUD slot.
    /// /params currentEnergy: Current slot energy value.
    ...
    /// /params displayedValue: Current displayed normalized value.
    /// /params targetValue: New normalized target value.
    /// /params smoothingSeconds: Time used to interpolate the value.
    ...
    private sealed class HUDPowerUpSlotVisual
    {
        ...
        /// /params iconImage: Direct icon image reference serialized on the HUD manager.
        /// /params energyFillImage: Energy fill image for the slot.
        /// /params chargeFillImage: Charge fill image for the slot.
        ...
        /// /params iconImageValue: Optional icon image shown above the module bars.
        /// /params energyBarValue: Energy bar visuals owned by the slot.
        /// /params chargeBarValue: Charge bar visuals owned by the slot.
        ...
        /// /params slotConfig: Active slot configuration currently bound to the player.
        /// /params currentEnergy: Current energy value stored for the slot.
        /// /params currentCharge: Current charge value stored for the slot.
        /// /params energySmoothingSeconds: Smoothing time applied to energy visuals.
        /// /params hideEnergyWhenModuleMissing: Hides the energy bar root when no module is present.
        /// /params chargeSmoothingSeconds: Smoothing time applied to charge visuals.
        /// /params hideChargeWhenModuleMissing: Hides the charge bar root when no module is present.
        /// /returns void.
        /// </summary>
        ...
        /// /params hideEnergyBar: Hides the energy bar when the player is unavailable.
        /// /params hideChargeBar: Hides the charge bar when the player is unavailable.
        /// /returns void.
        /// </summary>
        ...
        /// /params slotConfig: Active slot configuration currently bound to the player.
        /// /params currentEnergy: Current slot energy value.
        /// /params smoothingSeconds: Smoothing time applied to the displayed fill.
        /// /params hideWhenModuleMissing: Hides the energy bar root when no module is present.
        /// /returns void.
        /// </summary>
        ...
        /// /params slotConfig: Active slot configuration currently bound to the player.
        /// /params currentEnergy: Current slot energy value.
        /// /params currentCharge: Current slot charge value.
        /// /params smoothingSeconds: Smoothing time applied to the displayed fill.
        /// /params hideWhenModuleMissing: Hides the charge bar root when no module is present.
        /// /returns void.
        /// </summary>
    ...
    private readonly struct HUDPowerUpBarVisual
    {
        ...
        /// /params fillImage: Fill image bound in the HUD manager.
        ...
        /// /params fillImageValue: Fill image driven by runtime values.
        /// /params rootObjectValue: Root object that contains the bar background and fill.
        ...
        /// /params normalizedValue: Normalized fill amount written into the fill image.
        /// /returns void.
        /// </summary>
        ...
        /// /params displayedValue: Last displayed normalized value used when the bar remains visible.
        /// /params hideWhenMissing: Hides the entire bar hierarchy when true.
        /// /returns void.
        /// </summary>
        ...
        /// /params isVisible: Target active state for the bar root.
        /// /returns void.
        /// </summary>
