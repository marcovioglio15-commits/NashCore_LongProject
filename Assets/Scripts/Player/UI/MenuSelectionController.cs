...
public sealed class MenuSelectionController : MonoBehaviour
{
    ...
    /// /params selectable: Selectable that should become the new fallback target.
    /// /returns None.
    /// </summary>
    ...
    /// /params selectable: Selectable that should own navigation and submit input.
    /// /params rememberAsDefault: True when this selectable should become the new fallback target.
    /// /returns None.
    /// </summary>
    ...
    /// /params selectable: Hovered selectable reported by one menu button relay.
    /// /returns None.
    /// </summary>
    ...
    /// /params selectable: Selectable whose hover ownership has just ended.
    /// /returns None.
    /// </summary>
    ...
    /// /params selectable: Selectable that should own the current UI focus.
    /// /returns None.
    /// </summary>
    ...
    /// /params targetObject: GameObject that may carry a Selectable component.
    ...
    /// /params selectable: Selectable to validate.
